...
_Blog.changeTitle=function(){var currentTitle=document.title;window.onblur=function(){document.title='Cah Ndeso（＞﹏＜）';}
...
$('.theme-switch').on('click',()=>{$('body').toggleClass('dark-theme')
